		...
		<tr>
			<td>
				...
				<br>
					...
					Tender type  : <select required="required">
										<option value="none" selected disabled hidden> 
          									Select an Option 
     									 	</option> 
										  <option name="ttype" value="construction">Construction</option>
										  <option name="ttype" value="research">Research</option>
										  <option name="ttype" value="maintainence">Maintainence</option>
										  <option name="ttype" value="buisness">Buisness-implementation</option>
										  <option name="ttype" value="software">Software</option>
										  <option name="ttype" value="others">Others</option>
					...
					Descripton   : <input type="text" name="tdesc" required="required"><br/><br/>
